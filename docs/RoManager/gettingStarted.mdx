...
<DiscordMessages>
	...
	>
		<DiscordEmbed embedTitle="Setup" slot="embeds" color="#5865F2" thumbnail="https://i.jaydensar.net/rmt-min.png">
			<DiscordEmbedFields>
				<DiscordEmbedField fieldTitle="Id" inline inline-index={1}>12345678</DiscordEmbedField>
				<DiscordEmbedField fieldTitle="Owner" inline inline-index={2}>You</DiscordEmbedField>
			</DiscordEmbedFields>
		</DiscordEmbed>
